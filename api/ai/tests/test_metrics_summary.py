...
class AIMetricsSummaryTests(TestCase):
    ...
    def test_summary_aggregates(self):
        ...
        org_id = "orgA"
        AIMetric.objects.create(type="write", model_id="m", tokens_used=100, duration_ms=1000, success=True, created_by=self.user, org_id=org_id)
        AIMetric.objects.create(type="revise", model_id="m", tokens_used=50, duration_ms=500, success=True, created_by=self.user, org_id=org_id)
        AIMetric.objects.create(type="revise", model_id="m", tokens_used=150, duration_ms=1500, success=True, created_by=self.user, org_id=org_id)
