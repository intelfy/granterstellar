...
export function BillingPage({ token }) {
  ...
  // Best-effort: refresh usage so UI reflects any immediate changes (tests/dev)
  await refresh()
      }
    } catch (e) { setError('Checkout unavailable') } finally { setLoading(false) }
  }
  const openPortal = async () => {
    ...
    } catch (e) { setError('Portal unavailable') } finally { setLoading(false) }
  }
